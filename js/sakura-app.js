...
$(document).ready(function () {
  ...
  changeBG('#white-bg', '')
  changeBG('#sakura-bg', '/img/other/sakura.png')
  changeBG('#gribs-bg', '/img/other/plaid.jpg')
  changeBG('#pixiv-bg', '/img/other/star.png')
  changeBG('#KAdots-bg', '/img/other/point.png')
  changeBG('#totem-bg', '/img/other/little-monster.png')
  changeBG('#bing-bg', '/img/other/dark_bg.jpg')
  changeBGnoTrans('#dark-bg', '/img/other/starry_sky.png')
