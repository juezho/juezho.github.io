...
function loadTipsMessage(result) {
    ...
    $('.live2d-tool.save-live2d').click(function () {
        showMessage(getRandText(result.waifu.screenshot_message), 5000, true);
        window.Live2D.captureName = window.Live2D.captureName = 'Screenshot-' + Date.now() + '.png';
    ...
    if (getCookie("live2d") == "Hide") {
        ...
        $(".hide-live2d").addClass("hide-live2d-hide")
    }
    $('.live2d-tool.hide-live2d').click(function () {
        if (getCookie("live2d") == "Hide") {
            $(".hide-live2d").addClass("hide-live2d-hide")
            setTimeout(function () {
            ...
            $(".hide-live2d").removeClass("hide-live2d-hide")
            setTimeout(function () {
                $(".prpr").css("visibility", "hidden");
                if (document.body.clientWidth > 860) {
                    $(".hide-live2d").css("bottom", "66px");
